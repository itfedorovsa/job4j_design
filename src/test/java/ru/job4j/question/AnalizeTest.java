...
public class AnalizeTest {
    ...
    @Test
    public void whenOneChangedOneDeleted() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set<User> previous = Set.of(u1, u2, u3);
        Set<User> current = Set.of(new User(1, "AA"), u3);
        assertThat(Analize.diff(previous, current), is(new Info(0, 1, 1)));

    }

    @Test
    public void whenOneAddedOneDeleted() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set<User> previous = Set.of(u1, u2, u3);
        Set<User> current = Set.of(u2, u3, new User(4, "D"));
        assertThat(Analize.diff(previous, current), is(new Info(1, 0, 1)));
